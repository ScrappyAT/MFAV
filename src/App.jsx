...
// About/Services/ServiceDetail/Industries/Company/Contact are
...
// down to what "/" needs, instead of shipping all seven routes' code on
// every load. Suspense fallback is `null`: these are same-origin chunks
// on an already-warm connection, so a spinner would flash longer than the
