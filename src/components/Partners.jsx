 ...
 */
const CLIENTS = [
  { alt: 'First E&P', file: 'first-ep', left: '9.6935%', top: '65.7026%', lit: true },
  { alt: 'Seplat Energy', file: 'seplat', left: '22.107%', top: '30.9078%', lit: true },
  { alt: 'Petralon Energy', file: 'petralon', left: '40.0451%', top: '11.5982%', lit: true },
  { alt: 'NLNG', file: 'nlng', left: '59.9549%', top: '11.5982%', lit: true },
  { alt: 'Brightwaters Energy', file: 'brightwaters', left: '77.893%', top: '30.9078%', lit: true },
  { alt: 'Sahara Group', file: 'sahara', left: '90.3065%', top: '65.7026%', lit: true },
  { alt: 'Savannah Energy', file: 'savannah', left: '23.7913%', top: '73.8636%', lit: true },
  { alt: 'Saipem', file: 'saipem', left: '34.8684%', top: '48.0754%', lit: true },
  { alt: 'TotalEnergies', file: 'totalenergies', left: '50%', top: '38.6364%', lit: true },
  { alt: 'Tulcan Energy', file: 'tulcan', left: '65.1316%', top: '48.0754%', lit: true },
  { alt: 'Dangote Refinery', file: 'dangote-refinery', left: '76.2087%', top: '73.8636%', lit: true },
  { alt: 'Dangote Cement', file: 'dangote-cement', left: '36.3259%', top: '89.091%' },
  { alt: 'Deltaplus', file: 'deltaplus', left: '42.1053%', top: '74.4498%' },
  { alt: 'Safety Jogger', file: 'safety-jogger', left: '50%', top: '69.091%' },
  { alt: '3M', file: '3m', left: '57.8947%', top: '74.4498%' },
  { alt: 'Portwest', file: 'portwest', left: '63.6741%', top: '89.091%' },
];
