...
export const INDUSTRIES = [
  ...
  },
  {
    name: 'Maritime',
    mark: marks.maritime,
    relevance: 'Vessel operations, chartering and marine support for commercial shipping.',
  ...
  },
  {
    name: 'Energy',
    mark: marks.energy,
    relevance: 'Infrastructure and technical services for power generation and distribution.',
  ...
  },
  {
    name: 'Aviation',
    mark: marks.aviation,
    relevance: 'Charter, crew transfer and journey management for time-critical air travel.',
    detail: 'Time-critical travel for crew, executives and cargo doesn’t run on a scheduled-airline timetable. MFAV’s aviation division covers private jet and helicopter charter, crew rotation and journey management, coordinated where needed with marine operations for offshore crew transfer.',
    divisions: ['aviation', 'marine-offshore'],
  },
  {
    name: 'Construction',
    mark: marks.construction,
    relevance: 'Heavy equipment, haulage and materials logistics for civil works.',
  ...
  },
  {
    ...
    relevance: 'Pipeline, port and industrial infrastructure installation and upkeep.',
  ...
  },
  {
    ...
    relevance: 'Haulage, equipment transport and supply chain coordination end to end.',
    detail: 'Supply chains that depend on heavy or abnormal loads need route planning, permits and journey management handled before the load moves, not during. MFAV’s logistics & haulage division covers this end to end, with property and investment support where a supply chain needs port-adjacent facilities.',
    divisions: ['logistics-haulage', 'property-investment'],
  },
  {
    name: 'Industrial Operations',
    mark: marks.industrial,
    relevance: 'Equipment, PPE and technical support for plant and refinery operations.',
